package br.dev.diego.demoparkapi;
...
public class UsuarioIT {
    ...
    public void createUsuario_ComUsernameEPasswordValidos_RetornarUsuarioCriadoComStatus201() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.username()).isEqualTo("tody@email.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.role()).isEqualTo("CLIENTE");
    }
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.username()).isEqualTo("ana@email.com");
